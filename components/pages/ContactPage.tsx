            ...
            <div>
              ...
              {sent ? (
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 18 }}>
                  ...
                  <Field wide label="What can we help with?" name="message" placeholder="Tell us about your property, lot, or project…" type="area" value={form.message} onChange={set} error={errors.message} />
                  <div style={{ gridColumn: '1 / -1', marginTop: 4 }}>
                    <Button kind="green" size="lg" icon="arrow" onClick={submit}>Send request</Button>
                  </div>
                </div>
              )}
            </div>
              ...
              {CONTACT_ITEMS.map(({ icon, label, value, href }) => (
                <div
                  ...
                  style={{
                    ...
                    alignItems: 'center',
                    padding: '15px 0',
                    borderBottom: '1px solid rgba(10,35,66,.08)',
                  }}
                >
